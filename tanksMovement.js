...
let P1boolCollision = false;
let P2boolCollision = false;
...
function setup() {
    ...
    function createPlayer1() {
        ...
        player.div.style.backgroundImage = "url(TanksSprites/png/retina/tanks1.png)";
    ...
    function createPlayer2() {
        ...
        //adding the correct image to player
        player.div.style.backgroundImage = "url(TanksSprites/png/retina/tanks2.png)";
    ...
    function createBulletP1() {
        ...
        bullet.div.style.backgroundImage = "url(TanksSprites/PNG/retina/BulletRed1_outline.png)";
    ...
    function createBulletP2() {
        ...
        //adding the correct image to bullet
        bullet.div.style.backgroundImage = "url(TanksSprites/PNG/retina/BulletBlue1_outline.png)";
    ...
    function animateBullets() {
        ...
        for (let i = 0; i < P1bullets.length; i++) {
            ...
            if (collision(player2, bullet)) {
                ...
                bullet.h = 20;
                bullet.w = 20;
                bullet.div.style.backgroundImage = "url(TanksSprites/png/retina/explosion3.png)";
            ...
            else if (bullet.y < 0 || bullet.y> screenHeight){
                bullet.angle= -bullet.angle;
                bullet.stats.intCollision -=1;
            }
            ...
            console.log(bullet.stats.intCollision);
