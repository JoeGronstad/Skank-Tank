...
function setup() {
    ...
    function createBulletP1() {
        ...
        bullet.div.style.backgroundImage = "url(BulletRed1_outline.png)";
    ...
    function createBulletP2() {
        ...
        //adding the correct image to bullet
        bullet.div.style.backgroundImage = "url(BulletBlue1_outline.png)";
    ...
    function animateBullets() {
        ...
        for (let i = 0; i < P1bullets.length; i++) {
            ...
            if (collision(player2, bullet)) {
                ...
                bullet.h = 20;
                bullet.w = 20;
                bullet.div.style.backgroundImage = "url(explosion3.png)";
